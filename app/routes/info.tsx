    ...
    <div className="space-y-6 pt-4 pb-4">
      ...
      <div className="p-6 bg-white rounded-lg shadow-lg max-w-[90%] mx-auto text-center border border-gray-200">
        ...
        <p className="text-base leading-7 text-gray-600 mb-4 font-sans">
          ...
          cocktails, gourmet pizzas, crisp salads, and aromatic coffee. Our
          commitment to consistent quality ensures every visit is a culinary
          journey. Unwind, relish delicious fare, and let the beach vibes
          elevate your moments. Aiolia, your ultimate destination in Nea
          Anchialos and Volos. Cheers to shared memories and flavors that
          linger! 🏖️🍹
        </p>
      </div>
      <div className="p-6 bg-white rounded-lg shadow-lg max-w-[90%] mx-auto text-center border border-gray-200">
